...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__11961__auto__,writer__11962__auto__,opt__11963__auto__){return cljs.core._write.call(null,writer__11962__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_19362 = (0);while(true){
if((i_19362 < arr.length))
{(arr[i_19362] = null);
{
var G__19363 = (i_19362 + (1));
i_19362 = G__19363;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__11961__auto__,writer__11962__auto__,opt__11963__auto__){return cljs.core._write.call(null,writer__11962__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_19369 = (self__.level + (1));while(true){
if((i_19369 <= (new_level + (1))))
{(update[i_19369] = self__.header);
{
var G__19370 = (i_19369 + (1));
i_19369 = G__19370;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19371 = (0);while(true){
if((i_19371 <= self__.level))
{var links_19372 = (update[i_19371]).forward;if(((links_19372[i_19371]) === x__$1))
{(links_19372[i_19371] = (x__$1.forward[i_19371]));
{
var G__19373 = (i_19371 + (1));
i_19371 = G__19373;
continue;
}
} else
{{
var G__19374 = (i_19371 + (1));
i_19371 = G__19374;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__11394__auto__ = (cljs.core.truth_((function (){var and__11382__auto__ = me;if(cljs.core.truth_(and__11382__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__11382__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__11394__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__11394__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__11394__auto__,timeout__$1,me))
,msecs);
