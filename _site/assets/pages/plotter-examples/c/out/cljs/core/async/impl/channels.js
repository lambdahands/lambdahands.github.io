...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19461 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19461 = (function (val,box,meta19462){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19461.cljs$lang$type = true;
cljs.core.async.impl.channels.t19461.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19461";
cljs.core.async.impl.channels.t19461.cljs$lang$ctorPrWriter = (function (this__11961__auto__,writer__11962__auto__,opt__11963__auto__){return cljs.core._write.call(null,writer__11962__auto__,"cljs.core.async.impl.channels/t19461");
});
cljs.core.async.impl.channels.t19461.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19461.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19463){var self__ = this;
var _19463__$1 = this;return self__.meta19462;
});
cljs.core.async.impl.channels.t19461.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19463,meta19462__$1){var self__ = this;
var _19463__$1 = this;return (new cljs.core.async.impl.channels.t19461(self__.val,self__.box,meta19462__$1));
});
cljs.core.async.impl.channels.__GT_t19461 = (function __GT_t19461(val__$1,box__$1,meta19462){return (new cljs.core.async.impl.channels.t19461(val__$1,box__$1,meta19462));
});
}
return (new cljs.core.async.impl.channels.t19461(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__11964__auto__,writer__11965__auto__,opts__11966__auto__){return cljs.core._write.call(null,writer__11965__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__11961__auto__,writer__11962__auto__,opt__11963__auto__){return cljs.core._write.call(null,writer__11962__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_19464 = self__.takes.pop();if((taker_19464 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19464))
{var take_cb_19465 = cljs.core.async.impl.protocols.commit.call(null,taker_19464);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19465,taker_19464,this$__$1){
return (function (){return take_cb_19465.call(null,null);
});})(take_cb_19465,taker_19464,this$__$1))
);
} else
{}
{
...
var putter_19466 = self__.puts.pop();if(!((putter_19466 == null)))
{var put_handler_19467 = putter_19466.handler;var val_19468 = putter_19466.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_19467))
{var put_cb_19469 = cljs.core.async.impl.protocols.commit.call(null,put_handler_19467);var __19470__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_19469,__19470__$1,put_handler_19467,val_19468,putter_19466,_,retval,this$__$1){
return (function (){return put_cb_19469.call(null,true);
});})(put_cb_19469,__19470__$1,put_handler_19467,val_19468,putter_19466,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_19468);
} else
{{
continue;
}
