...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_19455 = (0);while(true){
var m_19456 = cljs.core.async.impl.dispatch.tasks.pop();if((m_19456 == null))
{} else
{m_19456.call(null);
if((count_19455 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__19457 = (count_19455 + (1));
count_19455 = G__19457;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__11382__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__11382__auto__)
